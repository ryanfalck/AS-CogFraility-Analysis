---
title: "Action Seniors - CogFrailty Analyses (August 6, 2022)"
author: "RSF"
date: "2022-07-29"
output: 
  html_document:
...
Note: All analyses used estimated average compliance for Cognitively Frail participants (44.0%) and non-CogFrail participants (51.1%). High compliance is ≥ mean compliance for each group.
...
# 5) Table 2 - Differences in baseline characteristics by Cognitive Frailty status
...
# 6) Supplementary Figure S1 - Differences in individual monthly compliance 
...
# 7) Table 3 - Primary and secondary outcomes at 12 months by cognitive frailty status and treatment group

Falls Incident Rate Ratio (Cognitively Frail Participants)
...
Falls Incident Rate Ratio (Non-Cognitively Frail Participants)
...
Differences in total exposure based on cognitive frailty and group
...
# 8) Figure 2 - Accumulation of falls by treatment group and cognitive frailty status
...
# 9) Figure 3- Differences in monthly compliance to the intervention based on cognitive frailty status and biological sex
...
Estimated differences in average compliance for cognitively frail and non-cognitively frail participants
```{r}
...
Estimated differences in average compliance based on cognitive frailty and biological sex
```{r}
...
# 10) Table 4 - Primary and secondary outcomes at 12 months in exercise group based on cognitive frailty status and compliance to the intervention 

Subset Exercise Group participants by cognitive frailty status
...
Falls Per Person-Year (Cognitively Frail Participants)
...
Falls Per Person-Year (Non-Cognitively Frail Participants)
